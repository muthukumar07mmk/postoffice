...
<section class="inner-w3ls">
	<div class="container">
		<h2 class="text-center w3 w3l agileinfo wthree">About India Post</h2>
...
<section class="cust-agileits">
	<div class="container">
		...
		<h3 class="text-center">Our Happy Customers</h3>
		<p class="text-center"> India Post has garnered immense appreciation from its customers on Twitter. In the last couple of months, India Post has started leveraging the potential of this channel for making instant communication with its customers.</p>	
        <!-- Our Customers -->	
