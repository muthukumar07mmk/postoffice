...
<section class="special-w3layouts">
	<div class="container">
		...
		<div class="col-lg-3 col-md-3 col-sm-6">
			...
			<p class="special-p1">Auto import and track India Post shipments through Your Unique ID</p>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6">
			<img src="images/monitor.png" alt="" class="img-responsive">
			<h4 class="text-center">Tracking API</h4>
			<p class="special-p1">Provide India Post tracking api for e-commerce developers to get real time India Post tracking info.</p>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6">
			<img src="images/shop.png" alt="" class="img-responsive">
			<h4 class="text-center">Ecommerce Integration</h4>
			<p class="special-p1"> E-commerce developers to get real time India Post tracking info.</p>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6">
			<img src="images/amazon-india-post.png" alt="" class="img-responsive">
			<h4 class="text-center">Delivered In Time</h4>
			<p class="special-p1">We can safely reach your packing to destination with in a Expected Date and Time.</p>
		</div>
...
<section class="info-w3ls2">
	<div class="container">
		...
		<p class="text-center">Quality in a service is not what you put into it. it is what the customer gets out of it.</p>
	</div>
</section>
<!-- /2nd info section -->
<!-- 3rd banner section -->
...
<section class="info-w3ls3">
	<div class="container">
		...
		<p class="text-center">Customer service shouldn't just be a department , it should be the entire Company.</p>
	</div>
</section>
<!-- /3rd info section -->
<!-- footer section -->
<section class="footer-agileits">
	<div class="container">
		...
		<div class="col-lg-3 col-md-3 col-sm-6">
			...
			<div class="contact-info">
				...
				<div class="email-info">
                    ...
                    <p class="p5"><br>webinformationmanager<br>@indiapost.gov.in</a></p> 
		...
		<div class="clearfix"></div>
		<hr>
		<p class="copyright">© 2018 Indian Post. All Rights Reserved | Design by <a  target="_blank">ERROR 404</a></p>
	</div>
</section>
<!-- /footer section -->
