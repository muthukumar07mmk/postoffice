...
<section class="inner-w3ls">
	<div class="container">
		...
		<p class="text-center w3layouts w3 w3l agileits agileinfo">To check the Tracking Status of your Parcel.</p>
	</div>
</section>
<!-- /banner section -->
<!-- tracking section -->
<section class="shipment-w3ls">
	<div class="container">
		...
		<p class="text-center wthree w3-agileits agileits-w3layouts agile w3-agile">Check current status of your shipment using Unique ID.</p>
	</div>
	<div class="container">
		<div class="content-w3ls">	
			<div class="content1-w3ls">
				<h2>Tracking: Unique ID</h2>
			</div>
			<div class="content2-w3ls">
				<div class="content2-header1">
					<p>Shipped Via : <span>Delhi</span></p>
				</div>
				<div class="content2-header1">
					<p>Status : <span>Checking Quality</span></p>	
				</div>
				<div class="content2-header1">
					<p>Expected Date : <span>30-MAR-2018</span></p>
				</div>
				<div class="clear"></div>
			</div>
			<div class="content3-w3ls">
				<div class="shipment">
					<div class="confirm">
						...
						<p>Sending Parcel&nbsp&nbsp&nbsp&nbsp</p>
					</div>
					<div class="process">
						<div class="imgcircle">
						...
						<span class="line"></span>
						<p>Processing &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p>
					</div>
					<div class="quality">
						<div class="imgcircle">
						...
						<span class="line"></span>
						<p>Quality Check&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p>
					</div>
					<div class="dispatch">
						<div class="imgcircle">
