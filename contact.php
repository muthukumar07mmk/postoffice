...
<section class="inner-w3ls">
	<div class="container">
		...
		<p class="text-center w3 w3l agileinfo wthree">Any complaint on the services rendered by the Department and concerning behavior of employees of the Department of Posts may be taken up with the Postmaster / In-charge of the Post Office where the transaction has taken place or Senior Superintendent / Superintendent of Post Offices.</p>
	</div>
</section>
<!-- /banner section -->
<!-- contact address -->
<section class="contact-us" id="contact">
	<div class="container">
		...
		<p class="text-center slideanim w3-agileits agileits-w3layouts agile w3-agile">You can register your Complaints by Contact Us.</p>
            <div class="col-md-8 slideanim">
                  <img class="googlemaps" src="images/map.png" style="border:0" allowfullscreen/>
            </div>
            <div class="col-md-4 slideanim">
				<h4>Our Contacts :</h4>
                <p><b>Phone</b> : 1800-11-2011</p>
                <p><b>Email</b> : <a>webinformationmanager<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@indiapost.gov.in</a></p>
                <p><b>Address</b> : Department of Posts <br>Dak Bhawan , Sansad Marg<br>New Delhi-110001</p>
            </div>
...
<section class="contact-w3ls">
	<div class="container">
		...
		<p class="text-center">You Can Send Your Complaints and Queries Here.</p>	
			...
			<form action="#" method="post" name="sentMessage" id="contactForm" novalidate>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 contact-agile2">
					...
					<div class="control-group form-group">
                        <div class="controls">
                            <label class="contact-p1">Unique ID:</label>
				...
				<div class="col-lg-12">	
                    ...
                    <button type="submit" class="btn btn-primary">Send Your Complaints</button>
				</div>
				<div class="clearfix"></div>	
            </form>            
...
<section class="footer-agileits">
	<div class="container">
		...
		<div class="col-lg-3 col-md-3 col-sm-6">
			...
			<div class="contact-info">
				...
				<div class="email-info">
					...
					<p class="p5"><a >webinformationmanager<br>@indiapost.gov.in</a></p> 
		...
		<div class="clearfix"></div>
		<hr>
		<p class="copyright">© 2018 India Post. All Rights Reserved | Design by  <a>ERROR 404</a></p>
	</div>
</section>
<!-- /footer section -->
